...
for i in range(0,len(primary)):
	...
	cell = primary.iloc[i]['Primary Cell Type']
	if (target == 'INPUT'):
		continue
	...
	primary.loc[primary.index[i], 'total_reads'] = primary_qc['align']['samstat']['rep1']['total_reads']
	primary.loc[primary.index[i], 'mapped'] = primary_qc['align']['samstat']['rep1']['mapped_reads']
	primary.loc[primary.index[i], 'proper_mapped'] = primary_qc['align']['samstat']['rep1']['properly_paired_reads']
	primary.loc[primary.index[i], 'filtered'] = primary_qc['align']['dup']['rep1']['paired_reads']*2
	primary.loc[primary.index[i], 'deduped'] = primary_qc['align']['nodup_samstat']['rep1']['total_reads']
	spikeIn.loc[spikeIn.index[i], 'total_reads'] = spikeIn_qc['align']['samstat']['rep1']['total_reads']
	spikeIn.loc[spikeIn.index[i], 'mapped'] = spikeIn_qc['align']['samstat']['rep1']['mapped_reads']
	spikeIn.loc[spikeIn.index[i], 'proper_mapped'] = spikeIn_qc['align']['samstat']['rep1']['properly_paired_reads']
	spikeIn.loc[spikeIn.index[i], 'filtered'] = spikeIn_qc['align']['dup']['rep1']['paired_reads']*2
	spikeIn.loc[spikeIn.index[i], 'deduped'] = spikeIn_qc['align']['nodup_samstat']['rep1']['total_reads']
